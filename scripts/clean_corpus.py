...
def main():
    ...
    lines_without_url = (line for line in lines_without_numbers if not contains_url(line))
    ...
    output_delete_dots_end_sentence = (delete_dots_end_sentence(line) for line in output_delete_punctuation)
    output_deal_with_apostrophe = (deal_with_apostrophe(line) for line in output_delete_dots_end_sentence)
